...
<head>
    ...
    <title>Grade 9 - Intermediate Lessons</title>
...
<body>
    ...
    <div class="main-content">
        <header>
            <h1>Grade 9 - Intermediate Lessons</h1>
        </header>
        <section class="lesson-content">
            <p>Welcome to Grade 9 Intermediate Lessons. Let's start learning!</p>
            ...
            <ul>
                <li><a href="/lingolearn/lessons/basics/grade9.php">Basic Grade 9</a></li>
                <li><a href="/lingolearn/lessons/advanced/grade9.php">Advanced Grade 9</a></li>
            </ul>
