...
<head>
    ...
    <title>Grade 10 - Intermediate Lessons</title>
...
<body>
    ...
    <div class="main-content">
        <header>
            <h1>Grade 10 - Intermediate Lessons</h1>
        </header>
        <section class="lesson-content">
            <p>Welcome to Grade 10 Intermediate Lessons. Let's start learning!</p>

            <!-- Links to other grades in Beginner Lessons -->
            <h3>Other Grades</h3>
            <ul>
                <li><a href="/lingolearn/lessons/intermediate/grade7.php">Grade 8</a></li>
                <li><a href="/lingolearn/lessons/intermediate/grade8.php">Grade 9</a></li>
                <li><a href="/lingolearn/lessons/intermediate/grade9.php">Grade 10</a></li>
            </ul>
