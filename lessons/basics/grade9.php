...
<body>
    ...
    <div class="main-content">
        <header>
            <h1>Grade 9 - Beginner Lessons</h1>
        </header>
        <section class="lesson-content">
            <p>Welcome to Grade 9 Basic Lessons. Let's start learning!</p>
            ...
            <ul>
                <li><a href="/lingolearn/lessons/intermediate/grade9.php">Intermediate Grade 9</a></li>
