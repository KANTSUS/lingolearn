...
<body>
    ...
    <div class="main-content">
        <header>
            <h1>Grade 8 - Beginner Lessons</h1>
        </header>
        <section class="lesson-content">
            <p>Welcome to Grade 8 Basic Lessons. Let's start learning!</p>
            ...
            <ul>
                <li><a href="/lingolearn/lessons/intermediate/grade8.php">Intermediate Grade 8</a></li>
