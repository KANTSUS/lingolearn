...
<head>
    ...
    <title>Grade 8 - advanced Lessons</title>
...
<body>
    ...
    <div class="main-content">
        <header>
            <h1>Grade 8 - advanced Lessons</h1>
        </header>
        <section class="lesson-content">
            <p>Welcome to Grade 8 advanced Lessons. Let's start learning!</p>
            ...
            <ul>
                ...
                <li><a href="/lingolearn/lessons/intermediate/grade8.php">Advanced Grade 8</a></li>
            </ul>
